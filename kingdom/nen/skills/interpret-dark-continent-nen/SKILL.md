...
description: Bind one concrete mission to exactly one reviewed AgentTool Nen skill and at most one advisory bookmark, optionally attaching the reviewed Darwin Browser preview evidence. Use only when the current user explicitly asks for AgentTool Nen ability binding, a portable provenance-bound Mission Lens card, Darwin Browser frontier evidence, or this exact skill by name. Do not use for the repository-native Nen Compass or Openweight expedition, general anime lore, character or person classification, repository ranking, a bare mention of Nen, or as authority to activate a skill or tool.
---
...
The repository's passive Nen Compass owns native expedition interpretation.
This Mission Lens is the separate AgentTool provenance layer. They share the
same eight trigger signals, but neither output activates or silently invokes
the other.
